...
__MOUDLE__ = 'client_console'  # 模块名
__DESCRIPT__ = u'HiveNet Client Console (控制台)'  # 模块描述
...
def main(**kwargs):
    ...
    ConsoleServer.console_main(
        ...
        default_config_file=os.path.join(_execute_file_path, 'conf/client_console_config.xml'),
        **kwargs
    )
